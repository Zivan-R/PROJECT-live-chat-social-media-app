        ...
        <div class="my-6 flex justify-between">
            <div class="flex space-x-6">
                <div class="flex items-center space-x-2">
                    <svg @click="likePost(post.id)" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 hover:text-red-600">
            ...
            <div>
                ...
                <form v-on:submit.prevent="deletePost(post.id)" method="post">
                    <button class=" mr-0 py-3 px-3 bg-red-600 text-white text-sm rounded-lg">Delete</button>
                </form>
